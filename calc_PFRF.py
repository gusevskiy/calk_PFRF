...
Label(root, text='Введи число 1').grid(column=0, row=0)
Label(root, text='(1 x 10 % =)').grid(column=0, row=1)
Label(root, text='(1 x 5 % =)').grid(column=0, row=2)
Label(root, text='Введи число 2').grid(column=0, row=3)
Label(root, text='(2 x 22 % =)').grid(column=0, row=4)
Label(root, text='(2 x 5.1 % =)').grid(column=0, row=5)
Label(root, text='(2 x 2.9 % =)').grid(column=0, row=6)
Label(root, text='Сумма 1 и 2').grid(column=0, row=7)
Label(root, text='(1,2 x 0,2 % =)').grid(column=0, row=8)
...
def perform_from_the_keybord(self):
    perform()
...
def delete_from_the_keybord(self):
    delet()


root.bind('<Return>', perform_from_the_keybord)
root.bind('<Delete>', delete_from_the_keybord)

button1 = Button(root, text='learn', command=perform, font=('Arial', 9, 'bold'), height=1, width=5)
button1.grid(column=1, row=9)

button2 = Button(root, text='del', command=delet, font=('Arial', 9, 'bold'), height=1, width=5)
